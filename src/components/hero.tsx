...
export function Hero() {
  return (
    <div className="wrap" id="intro">
      ...
      <div className="flex flex-col items-center gap-10 py-10 pb-16 lg:flex-row lg:justify-center lg:gap-20 lg:py-14 lg:pb-20">
        <Image
          src="/mike-primak.png"
        ...
        <div className="flex max-w-[600px] flex-col items-center text-center">
          ...
          <ul className="mb-8 flex flex-wrap justify-center gap-x-2.5 gap-y-2">
            {hero.stack.map((s) => (
              <li
                key={s}
